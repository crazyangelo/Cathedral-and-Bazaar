...
市集模式通过充分利用"不自我中心编程"效应，有力地减轻了Brooks定律的影响。Brooks定律背后的原理并没有被废除，但考虑到庞大的开发者群体和廉价的通信，它的影响会被在其他方面并不明显但更有力的的非线性效应所淹没。这类似于牛顿物理学和爱因斯坦物理学之间的关系--旧系统在低速运动体系下仍然有效，但如果你把质量和速度推得足够高，你就会得到惊喜，比如核爆炸或Linux。
